...
public class PersonDAO{      
	...
	/* Person Table needs to be created in the Postgresql Database.
	 * create table Person (
	id Integer,
	name Varchar(30),
	address Varchar(30),
	...
	private String userid = "kieha";
	private String password = "njerry";
	...
	public PersonDAO(){
		...
		getConnection();		//Create Connection to the Postgresql Database
	}
